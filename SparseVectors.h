...
template<class T>
class SparseVectors//реализован на словаре
{//в ячейке находится 0, то в словарь не добавили ( словарь говорит, что мы не находим элемент) /из экономии места
private://а если нашли то возващает значение
